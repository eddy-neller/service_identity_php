...
Fichier documenté : `../../../../../src/Infrastructure/Adapter/Token/JwtAccessTokenUser.php`.
...
Recharger `App\Infrastructure\Persistence\Doctrine\User\UserEntity` uniquement pour satisfaire
