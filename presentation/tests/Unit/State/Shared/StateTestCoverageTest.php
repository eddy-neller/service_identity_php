 ...
 *   src   : presentation/src/<Context>/State/<rest...>/<Name>.php
 *   test  : presentation/tests/Unit/State/<Context>/<rest...>/<Name>Test.php
 */
final class StateTestCoverageTest extends TestCase
{
     ...
     * src  presentation/src/Shop/State/Catalog/Category/CategoryGetProvider.php
     * test presentation/tests/Unit/State/Shop/Catalog/Category/CategoryGetProviderTest.php.
     */
