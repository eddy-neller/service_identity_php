...
> Couche `presentation/`. Règles transverses : voir `AGENTS.md` racine.
...
`StateTestCoverageTest` (suite `pres.state.shared`) scanne `presentation/src/**/State` et casse le build
