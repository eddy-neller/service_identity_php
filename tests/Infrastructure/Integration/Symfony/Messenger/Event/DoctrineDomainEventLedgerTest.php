...
namespace App\Tests\Infrastructure\Integration\Symfony\Messenger\Event;
...
{
    private const string HANDLER = 'App\Tests\Infrastructure\Integration\Symfony\Messenger\Event\FakeHandler';
