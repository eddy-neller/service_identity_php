...
final class ActiveEmailTest extends TestCase
{
    ...
    {
        $activeEmail = ActiveEmail::create(mailSent: 1);
        $data = $activeEmail->jsonSerialize();
    ...
    {
        $activeEmail = ActiveEmail::create(token: 'old-token');
    ...
    {
        $activeEmail = ActiveEmail::create(token: 'token');
    ...
    {
        $activeEmail = ActiveEmail::create(tokenTtl: 1000);
    ...
    public function testWithLastAttemptCreatesNewInstance(): void
    {
        ...
        $activeEmail = ActiveEmail::create(lastAttempt: $oldDate);
    ...
    {
        $date = new DateTimeImmutable('2024-01-01T12:00:00+00:00');
        $activeEmail = ActiveEmail::create(lastAttempt: $date);
    ...
    {
        $activeEmail = ActiveEmail::create(lastAttempt: new DateTimeImmutable());
